                    ...
                    <form class="max-w-sm mx-auto my-5" action="{{ route('postSave') }}" method="POST"
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" name="title"
                                class="shadow-sm bg-purple-50 border border-purple-300 text-purple-900 text-sm rounded-lg focus:ring-purple-500 focus:border-purple-500 block w-96 p-2.5"
                        ...
                        <div class="mb-5">
                            <label class="block mb-2 text-sm font-medium text-purple-900" for="file_input">Post
                                Image</label>
                            <input
                                class="block w-full text-lg text-purple-900 border border-purple-300 rounded-lg cursor-pointer bg-purple-50 p-2.5"
