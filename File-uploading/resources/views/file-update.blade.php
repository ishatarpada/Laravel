    ...
    <div class="container mx-auto my-5 p-5">
        ...
        <div class="flex justify-center">
            <div class="w-full max-w-lg">
                <h2 class="text-center mb-2 text-2xl font-serif text-green-300">
                    Upadte : File Upload
                </h2>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-file"
                                    ...
                                    <input id="dropzone-file" type="file" class="hidden" name="photo" onchange="document.querySelector('#output').src=window.URL.createObjectURL(this.files[0])"
                                        accept="image/*" />
                                </label>
                            </div>
